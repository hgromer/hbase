...
public final class BackupUtils {
  ...
  public static RestoreRequest createRestoreRequest(String backupRootDir, String backupId,
    ...
    return createRestoreRequest(backupRootDir, backupId, check, fromTables, toTables, isOverwrite, false);
  }

  public static RestoreRequest createRestoreRequest(String backupRootDir, String backupId,
    boolean check, TableName[] fromTables, TableName[] toTables, boolean isOverwrite, boolean isKeepOriginalSplits) {
    ...
    RestoreRequest request =
      builder.withBackupRootDir(backupRootDir).withBackupId(backupId).withCheck(check)
        .withFromTables(fromTables).withToTables(toTables).withOvewrite(isOverwrite).withKeepOriginalSplits(isKeepOriginalSplits).build();
    return request;
  }
